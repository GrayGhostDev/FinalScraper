...
USER_AGENTS = [
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36",
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/90.0.4430.85 Safari/537.36",
...
PRICING = {
    ...
    # Removed "Groq Llama3.1 70b" as it's no longer used
...
# Removed GROQ_LLAMA_MODEL_FULLNAME as it's no longer used
...
# Default prompt for pagination detection
PROMPT_PAGINATION = """
