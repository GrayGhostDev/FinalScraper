...
# interactions
from main.input.pointer import Pointer
from main.types.webelement import WebElement
from main.scripts.switch_to import SwitchTo

# contexts
from main.sync.context import Context as SyncContext
from main.types.context import Context

# Targets
from main.scripts.driver_utils import get_target
from main.types.target import Target, TargetInfo
from main.types.base_target import BaseTarget
from main.sync.base_target import BaseTarget as SyncBaseTarget

# others
from cdp_socket.utils.conn import get_json
from main.types.options import Options as ChromeOptions
from main.utils.utils import sel_driverless_path
from main.types import JSEvalException
from main import EXC_HANDLER
...
class Chrome:
    ...
    def __init__(
        ...
        if not options.binary_location:
            from main.utils.utils import find_chrome_executable
    ...
    async def start_session(self):
        if not self._started:
            from main.utils.utils import read
            from main.utils.utils import is_first_run, get_default_ua, set_default_ua
            from main.scripts.prefs import read_prefs, write_prefs
            ...
            if not self._options.debugger_address:
                from main.utils.utils import random_port
                port = random_port()
