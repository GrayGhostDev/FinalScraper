...
# pointer
from main.sync.pointer import Pointer as SyncPointer
from main.input.pointer import Pointer
# other
from main.scripts.driver_utils import get_targets, get_target, get_cookies, get_cookie, delete_cookie, \
    delete_all_cookies, add_cookie
from main.utils.utils import safe_wrap_fut
from main.types.deserialize import StaleJSRemoteObjReference
from main.types.webelement import StaleElementReferenceException, NoSuchElementException
from main.sync.alert import Alert as SyncAlert
# Alert
from main.types.alert import Alert
from main.types.webelement import WebElement
from main.sync.webelement import WebElement as SyncWebElement
...
class Target:
    ...
    async def _global_this(self, context_id: str = None):
        ...
        if (not self._global_this_.get(context_id)) or self._loop:
            from main.types.deserialize import JSRemoteObj
